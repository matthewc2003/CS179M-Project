...
def generate_recommendation(
    ...
    advice_lines.append(
        f"Your dietary pattern most closely resembles Cluster {cluster}, "
    ...
    advice_lines.append(
        "\nThese comparisons reflect how your nutrient distribution "
        "aligns with national dietary patterns. "
        "They are not medical diagnoses."
    )

    advice_lines.append(
        "General population guidance often emphasizes increasing fiber-rich foods "
        "such as vegetables, fruits, legumes, and whole grains, "
        "while moderating added sugars, sodium, and saturated fat."
    )
